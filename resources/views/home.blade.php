      ...
      <div class="row">
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="//pix8.agoda.net/hotelImages/6800836/0/8abe589ac063a897aea9bf69303484bf.jpg?ce=0&s=350x260" alt="">
            <div class="card-body">
              <p class="card-text">

                @if( $temp->isOk )
                    Temperatura {{ $city->name }}: {{ number_format( $temp->data->main->temp, 1) }} {{ $city->sign }}
                @else
                    {{ $temp->message }}
                @endif
...
<footer class="text-muted">
  <div class="container">
    ...
    <p>Test example is &copy; Bootstrap, but please download and customize it for yourself!</p>
